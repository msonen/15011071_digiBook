...
import static com.example.digiBook.DataManager.BACKUP_FILE_NAME;
import static com.example.digiBook.DataManager.BACKUP_FOLDER_PATH;
import static com.example.digiBook.DataManager.NEW_NOTE_REQUEST;
import static com.example.digiBook.DataManager.NOTES_FILE_NAME;
...
import static com.example.digiBook.DataManager.NOTE_FAVOURED;
...
import static com.example.digiBook.DataManager.deleteNotes;
import static com.example.digiBook.DataManager.isExternalStorageReadable;
import static com.example.digiBook.DataManager.isExternalStorageWritable;
import static com.example.digiBook.DataManager.retrieveData;
import static com.example.digiBook.DataManager.saveData;
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (searchActive) {
            ...
            try {
                ...
                intent.putExtra(NOTE_AUDIO, notes.getJSONObject(newPosition).getString(NOTE_AUDIO));
                intent.putExtra(NOTE_PIC, notes.getJSONObject(newPosition).getString(NOTE_PIC));
                intent.putExtra(NOTE_DOC, notes.getJSONObject(newPosition).getString(NOTE_DOC));
                intent.putExtra(NOTE_DATE, notes.getJSONObject(newPosition).getString(NOTE_DATE));
                intent.putExtra(NOTE_VIDEO, notes.getJSONObject(newPosition).getString(NOTE_VIDEO));
                intent.putExtra(NOTE_REMINDER, notes.getJSONObject(newPosition).getString(NOTE_REMINDER));
        ...
        // If search is not active -> use normal position for EditActivity
            ...
            try {
                ...
                intent.putExtra(NOTE_AUDIO, notes.getJSONObject(position).getString(NOTE_AUDIO));
                intent.putExtra(NOTE_PIC, notes.getJSONObject(position).getString(NOTE_PIC));
                intent.putExtra(NOTE_DOC, notes.getJSONObject(position).getString(NOTE_DOC));
                intent.putExtra(NOTE_DATE, notes.getJSONObject(position).getString(NOTE_DATE));
                intent.putExtra(NOTE_VIDEO, notes.getJSONObject(position).getString(NOTE_VIDEO));
                intent.putExtra(NOTE_REMINDER, notes.getJSONObject(position).getString(NOTE_REMINDER));
            ...
            if (mBundle != null) {
                ...
                if (requestCode == NEW_NOTE_REQUEST) {
                    ...
                    try {
                        ...
                        newNoteObject.put(NOTE_AUDIO, mBundle.getString(NOTE_AUDIO));
                        newNoteObject.put(NOTE_DOC, mBundle.getString(NOTE_DOC));
                        newNoteObject.put(NOTE_PIC, mBundle.getString(NOTE_PIC));
                        newNoteObject.put(NOTE_DATE, mBundle.getString(NOTE_DATE));
                        newNoteObject.put(NOTE_VIDEO, mBundle.getString(NOTE_VIDEO));
                        newNoteObject.put(NOTE_REMINDER, mBundle.getString(NOTE_REMINDER));
