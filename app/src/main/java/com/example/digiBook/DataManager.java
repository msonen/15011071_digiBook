...
import static com.example.digiBook.MainActivity.*;
...
class DataManager {
    ...
    static final String BACKUP_FOLDER_PATH = "/digiBook"; // Backup folder path
    static final String BACKUP_FILE_NAME = "_backup.json"; // Backup file name
    ...
    static final String NOTE_DOC = "document";
    static final String NOTE_VIDEO = "video";
    static final String NOTE_PIC = "photo";
