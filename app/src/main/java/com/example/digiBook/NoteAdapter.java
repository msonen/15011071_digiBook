...
import static com.example.digiBook.DataManager.*;
...
class NoteAdapter extends BaseAdapter implements ListAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        TextView dateView = (TextView)convertView.findViewById(R.id.dateViewList);
        ...
        if (noteObject != null) {
            ...
            try {
                ...
                long timestamp = Long.parseLong(noteObject.getString(NOTE_DATE));
                DateFormat dateFormat = DateFormat.getDateTimeInstance();
                dateView.setText(dateFormat.format(new Date(timestamp)));
